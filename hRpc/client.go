...
func (client *TcpClient) input() {
	...
	if debugLog && err != io.EOF && !closing {
		hLog.Error("rpc: client protocol error:", err)
	}
}
...
func (call *Call) done() {
	...
	default:
		...
		if debugLog {
			hLog.Debug("rpc: discarding Call reply due to insufficient Done chan capacity")
		}
	}
}
